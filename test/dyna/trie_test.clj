...
(deftest small-trie
  (let [trie (make-PrefixTrie 2 0 {:a {:b [1]
                                   :c [2 3]}})
...
(deftest nil-val-trie
  (let [trie (make-PrefixTrie 2 0x1 {:a {:b [1]
                                     :c [2 3]}
                                 nil {:b [4]
                                      :d [5]}})
...
(deftest merge-tries
  (let [trie1 (make-PrefixTrie 2 0 {:a {:b [1]
                                    :c [2 3]}})
        trie2 (make-PrefixTrie 2 0 {:a {:b [3]
                                    :d [4]}})
...
(deftest hash-trie-different-order
  (let [trie1 (make-PrefixTrie 2 0 {:a {:b [1 2 3]}})
        trie2 (make-PrefixTrie 2 0 {:a {:b (list 3 1 2)}})]
...
(deftest trie-map-values-test
  (let [trie1 (make-PrefixTrie 2 0x1 {:a {:b [1]
                                      :c [2 3]}
                                  nil {:b [4]
                                       :d [5]}})
