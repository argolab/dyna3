...
(deftest small-trie
  (let [trie (make-PrefixTrie 2 0 {:a {:b (ClojureUnorderedVector/create [1])
...
(deftest nil-val-trie
  (let [trie (make-PrefixTrie 2 0x1 {:a {:b (ClojureUnorderedVector/create [1])
                                         :c (ClojureUnorderedVector/create [2 3])}
                                     nil {:b (ClojureUnorderedVector/create [4])
...
(deftest merge-tries
  (let [trie1 (make-PrefixTrie 2 0 {:a {:b (ClojureUnorderedVector/create [1])
                                        :c (ClojureUnorderedVector/create [2 3])}})
        trie2 (make-PrefixTrie 2 0 {:a {:b (ClojureUnorderedVector/create [3])
...
(deftest hash-trie-different-order
  (let [trie1 (make-PrefixTrie 2 0 {:a {:b (ClojureUnorderedVector/create [1 2 3])}})
        trie2 (make-PrefixTrie 2 0 {:a {:b (ClojureUnorderedVector/create (list 3 1 2))}})]
...
(deftest trie-map-values-test
  (let [trie1 (make-PrefixTrie 2 0x1 {:a {:b (ClojureUnorderedVector/create [1])
                                          :c (ClojureUnorderedVector/create [2 3])}
                                      nil {:b (ClojureUnorderedVector/create [4])
                                           :d (ClojureUnorderedVector/create [5])}})
